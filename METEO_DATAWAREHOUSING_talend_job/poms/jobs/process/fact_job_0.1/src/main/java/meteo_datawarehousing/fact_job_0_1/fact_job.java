...
package meteo_datawarehousing.fact_job_0_1;
...
/**
 * Job: fact_job Purpose: job de la table des faits<br>
 * Description: job de la table des faits <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class fact_job implements TalendJob {
	...
	private final String jobName = "fact_job";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(fact_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class meteo_faitStruct implements routines.system.IPersistableRow<meteo_faitStruct> {
		final static byte[] commonByteArrayLock_METEO_DATAWAREHOUSING_fact_job = new byte[0];
		static byte[] commonByteArray_METEO_DATAWAREHOUSING_fact_job = new byte[0];

		public Integer temps_id;

		public Integer getTemps_id() {
			return this.temps_id;
		}

		public Integer temperature_humide_id;

		public Integer getTemperature_humide_id() {
			return this.temperature_humide_id;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_METEO_DATAWAREHOUSING_fact_job) {

				try {

					int length = 0;

					this.temps_id = readInteger(dis);

					this.temperature_humide_id = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.temps_id, dos);

				// Integer

				writeInteger(this.temperature_humide_id, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("temps_id=" + String.valueOf(temps_id));
			sb.append(",temperature_humide_id=" + String.valueOf(temperature_humide_id));
		 ...
		 * Compare keys
		 */
		public int compareTo(meteo_faitStruct other) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_METEO_DATAWAREHOUSING_fact_job.length) {
					if (length < 1024 && commonByteArray_METEO_DATAWAREHOUSING_fact_job.length == 0) {
						commonByteArray_METEO_DATAWAREHOUSING_fact_job = new byte[1024];
					} else {
						commonByteArray_METEO_DATAWAREHOUSING_fact_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_METEO_DATAWAREHOUSING_fact_job, 0, length);
				strReturn = new String(commonByteArray_METEO_DATAWAREHOUSING_fact_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				meteo_faitStruct meteo_fait = new meteo_faitStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "meteo_fait");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("meteo_fait");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("meteo_fait");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:hW0XO8vrT/QLmXhwXIF3G/AVLX7QCTE4MOCaVPgQzAHxFw==");
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"temps_id\",\"temperature_humide_id\",\"location_id\",\"humidite_relative\",\"temperature_air\") VALUES (?,?,?,?,?)";
...
// # Outputs initialization
				meteo_faitStruct meteo_fait_tmp = new meteo_faitStruct();
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:l6w8msOUQfnmCIGhjw6Yy4dSU9RVjsi4DEvAmWETtgEsUA==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row3__id = row1.id;
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row4__id = row1.id;
...
// # Output table : 'meteo_fait'
								meteo_fait_tmp.temps_id = row3.id;
								meteo_fait_tmp.temperature_humide_id = row4.id;
								meteo_fait_tmp.location_id = row2.id;
								meteo_fait_tmp.humidite_relative = row1.humidite_relative;
								meteo_fait_tmp.temperature_air = row1.temperature_humide;
								meteo_fait = meteo_fait_tmp;
...
// Start of branch "meteo_fait"
						if (meteo_fait != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection(iterateId, 1, 1, "meteo_fait");
							}

							whetherReject_tDBOutput_1 = false;
							if (meteo_fait.temps_id == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(1, meteo_fait.temps_id);
							}

							if (meteo_fait.temperature_humide_id == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(2, meteo_fait.temperature_humide_id);
							}

							if (meteo_fait.location_id == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(3, meteo_fait.location_id);
							}

							if (meteo_fait.humidite_relative == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.DOUBLE);
							} else {
								pstmt_tDBOutput_1.setDouble(4, meteo_fait.humidite_relative);
							}

							if (meteo_fait.temperature_air == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.DOUBLE);
							} else {
								pstmt_tDBOutput_1.setDouble(5, meteo_fait.temperature_air);
							}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "meteo_fait");
				}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row2,row3,row4) outputs:(meteo_fait)
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:H7UHlOZlQrYUPfLXiUCknLdObeJ10/Y+NW/oNeRdH9tPzQ==");

				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;

				String url_tDBInput_2 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "meteo_cube";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row2.pays = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
						}
						if (colQtyInRs_tDBInput_2 < 3) {
							row2.ville = null;
						} else {

							row2.ville = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
						}
	...
	public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.jours_semaine = readInteger(dis, ois);

				this.nom_jours = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.jours_semaine, dos, oos);

				writeString(this.nom_jours, dos, oos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:RvagqfKavlXYnYxznQr60ynKzMz5Zbg1BYYSn9sxFtvTqg==");

				String dbPwd_tDBInput_3 = decryptedPassword_tDBInput_3;

				String url_tDBInput_3 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "meteo_cube";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							row3.date_key = rs_tDBInput_3.getInt(2);
							if (rs_tDBInput_3.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							row3.heure = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 3);
						}
						...
						if (colQtyInRs_tDBInput_3 < 5) {
							...
							row3.mois = rs_tDBInput_3.getInt(5);
							if (rs_tDBInput_3.wasNull()) {
								row3.mois = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 6) {
							...
							row3.nom_mois = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, false);
						}
						if (colQtyInRs_tDBInput_3 < 7) {
							row3.jours = null;
						} else {

							row3.jours = rs_tDBInput_3.getInt(7);
							if (rs_tDBInput_3.wasNull()) {
								row3.jours = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 8) {
							row3.jours_semaine = null;
						} else {

							row3.jours_semaine = rs_tDBInput_3.getInt(8);
							if (rs_tDBInput_3.wasNull()) {
								row3.jours_semaine = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 9) {
							...
							row3.nom_jours = routines.system.JDBCUtil.getString(rs_tDBInput_3, 9, false);
						}
						...
						row3_HashRow.jours = row3.jours;

						row3_HashRow.jours_semaine = row3.jours_semaine;

						row3_HashRow.nom_jours = row3.nom_jours;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:wrQi7Hx9JOaoBCoU1j0kxID95FiRS1cYEfBXus1ve8Ugeg==");

				String dbPwd_tDBInput_4 = decryptedPassword_tDBInput_4;

				String url_tDBInput_4 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "meteo_cube";
				...
				String dbquery_tDBInput_4 = "SELECT \n  \"dim_temperature_humide\".\"id\", \n  \"dim_temperature_humide\".\"temperature_humide\"\nFROM \"dim_tempera"
						+ "ture_humide\"";
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							row4.temperature_humide = null;
						} else {

							row4.temperature_humide = rs_tDBInput_4.getDouble(2);
							if (rs_tDBInput_4.wasNull()) {
								row4.temperature_humide = null;
							}
						}
						...
						row4_HashRow.temperature_humide = row4.temperature_humide;
	...
	public static void main(String[] args) {
		final fact_job fact_jobClass = new fact_job();

		int exitCode = fact_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = fact_job.class.getClassLoader()
					.getResourceAsStream("meteo_datawarehousing/fact_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = fact_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fact_job");
		}
...
/************************************************************************************************
 * 137144 characters generated by Talend Open Studio for Big Data on the 8 avril
 * 2025 02:02:50 UTC
 ************************************************************************************************/